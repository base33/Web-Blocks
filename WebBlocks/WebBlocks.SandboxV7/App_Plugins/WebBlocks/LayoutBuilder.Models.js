...
(function (WebBlocks) {
    ...
    (function (API) {
        ...
        var WebBlocksAPIClent = (function () {
            ...
            WebBlocksAPIClent.GetIdFromGuid = function (guid, $http, callback) {
                HttpRequest.Get("/umbraco/backoffice/WebBlocks/WebBlocksApi/GetIdFromGuid?guid=" + guid, $http, function (id) {
                    callback(id);
                });
            };
