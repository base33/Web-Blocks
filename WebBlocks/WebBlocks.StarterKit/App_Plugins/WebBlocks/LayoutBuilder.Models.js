...
(function (WebBlocks) {
    ...
    (function (LayoutBuilder_1) {
        ...
        var ElementBlock = /** @class */ (function (_super) {
            __extends(ElementBlock, _super);
            function ElementBlock() {
                var _this = _super.call(this) || this;
                _this.Class = "";
                _this.Children = [];
                _this.__type = "ElementBlock";
                return _this;
            }
            return ElementBlock;
        }(Block));
        LayoutBuilder_1.ElementBlock = ElementBlock;
        var BlockViewModel = /** @class */ (function () {
            function BlockViewModel() {
                ...
                //griddy stuff
                this.EnableAddGrid = false;
                this.EnableAddBlock = false;
            }
        ...
        var BlockType = /** @class */ (function () {
            ...
            BlockType.Element = "ElementBlock";
            return BlockType;
        }());
        ...
        var TypedBlockConverter = /** @class */ (function () {
            ...
            TypedBlockConverter.TypeIt = function (block) {
                ...
                if (typedBlock instanceof ElementBlock) {
                    typedBlock.Class = block.Class;
                    typedBlock.Children = this.TypeAll(block.Children);
                }
                return typedBlock;
            };
