...
interface JQueryStatic {
    ...
    sidr(action: any, element: any, callback: any): any;
    sidr(action: any, element: any): any;
}
...
interface JQuery {
    ...
    live(event: string, func: any): void;

    sortable(options: any): void;

    dialog(options: any): DialogReturn;

    effect(effect: any, options: any, duration: any, callback: any): void;

    draggable(options: any): void;

    sidr(options: any): any;

    droppable(options: any): any;
}
